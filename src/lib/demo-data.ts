...
export const USE_CASE_FIXTURES: Record<DemoSlug, UseCaseFixture> = {
  ...
  'family-holiday': {
    ...
    scenarioBody: [
      ...
      'WhenMeets는 시간 단위 없이 날짜만 받는 **날짜 전용 모드**를 지원합니다. 추석 연휴 4일을 후보로 띄우면, 어머니부터 사촌까지 **가능**과 **불가능**만 탭으로 표시합니다. 손가락 한 번에 한 날짜.',
  ...
  'team-meeting': {
    ...
    scenarioBody: [
      ...
      'WhenMeets로 다음 한 주의 평일 5일과 09~18시 시간대를 잡고 링크를 슬랙 채널에 던지면, 팀원은 30초 안에 가능한 슬롯을 드래그합니다. 결과 화면에서 **전원 가능**과 **if needed**까지 한눈에 구분됩니다.',
