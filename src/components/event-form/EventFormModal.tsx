          ...
          >
            ...
            >
              ...
              <input
                ...
                placeholder="이벤트 제목"
                className={`w-full px-4 py-2.5 border rounded-md transition-all focus:border-teal-600 ${
                  titleError
                  ...
                  {showPassword && (
                    ...
                    >
                      <input
                        ...
                        placeholder="비밀번호"
                        className="mt-1.5 w-full px-3 py-2 text-sm border border-gray-200 rounded-md focus:border-teal-600"
                      />
                    </motion.div>
                  )}
                </AnimatePresence>
