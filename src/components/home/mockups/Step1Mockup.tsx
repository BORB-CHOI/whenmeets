export default function Step1Mockup() {
  return (
    <div className="w-full max-w-65 bg-white rounded-xl shadow-md border border-gray-200/60 p-3">
      ...
      <div className="mb-2">
        ...
        <div className="h-7 rounded-md bg-gray-50 border border-gray-200 flex items-center px-2 text-[11px] text-gray-700 font-medium">
          팀 회의
        </div>
      </div>
      ...
      <div className="mb-2">
        ...
        <div className="grid grid-cols-7 gap-0.5">
          ...
          {Array.from({ length: 7 }).map((_, i) => {
            const isSelected = [3, 4, 5].includes(i);
            return (
              <div
                key={i}
