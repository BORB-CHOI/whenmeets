export default function Step2Mockup() {
  return (
    <div className="w-full max-w-65 flex flex-col items-center gap-3">
      ...
      <div className="w-full bg-white rounded-xl shadow-md border border-gray-200/60 overflow-hidden">
        <div className="flex items-center justify-between gap-2 px-3 py-2.5 border-b border-gray-100">
          ...
          <div className="h-6 px-2 inline-flex items-center gap-1 rounded-md border border-gray-200 bg-white text-[9px] font-medium text-teal-600 shadow-sm shrink-0">
