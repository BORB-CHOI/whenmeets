...
const FAQS = [
  {
    ...
    a: 'when2meet은 2008년에 만들어진 그대로라 모바일에서 드래그가 거의 안 되고, 한국어가 없으며, 이벤트를 만든 후에는 수정도 불가합니다. WhenMeets는 모바일 그리드부터 다시 그렸고, 한국어 + 응답 비밀번호 보호 + 요일 모드 + 카카오톡 인앱 호환 안내 등 한국 모바일 사용자가 부딪히는 마찰 위주로 다듬었습니다.',
  },
  {
    q: 'Timeful 같은 모던 스케줄링 툴과는 어떻게 다른가요?',
    a: 'Timeful은 Google/Outlook 캘린더 연동이 핵심이라 참가자 모두가 같은 캘린더 생태계에 있어야 효과를 봅니다. WhenMeets는 반대 가정에서 출발 — 카톡 그룹채팅처럼 회원가입도 캘린더도 다 다른 사람들 사이의 가벼운 약속 조율이 1순위입니다. 그 대신 현재 캘린더 연동은 미지원 (장기 검토).',
  },
  {
