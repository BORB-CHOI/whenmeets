...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Timeful은 일정을 입력하려면 로그인이 필요하고, 무료 플랜은 월 3회 제한이 있습니다. WhenMeets는 비로그인으로도 일정 입력 가능, 횟수 제한 없음. 또 결과 그리드가 색 농도로 "몇 명이 이 시간에 된다고 했는지"를 더 직관적으로 보여주고, 가능한 시간을 모으는 모드 외에 "안 되는 시간"을 모으는 모드도 지원해서 빈 시간이 더 많은 모임에서 입력 부담을 줄일 수 있습니다.',
  },
  {
