    ...
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <div className="flex flex-col gap-8 text-sm leading-relaxed text-gray-700">
        <section>
          ...
          <p>본 약관은 DayMeet(이하 &ldquo;서비스&rdquo;)가 제공하는 그룹 일정 조율 도구의 이용 조건과 절차,
        ...
        <section>
          <h2 className="text-base font-bold text-gray-900 mb-2">제4조 (서비스 제공)</h2>
          <ul className="list-disc pl-6 flex flex-col gap-1.5">
        ...
        <section>
          <h2 className="text-base font-bold text-gray-900 mb-2">제5조 (이용자의 의무)</h2>
        ...
        <section>
          <h2 className="text-base font-bold text-gray-900 mb-2">제6조 (콘텐츠와 데이터)</h2>
          <ul className="list-disc pl-6 flex flex-col gap-1.5">
        ...
        <section>
          <h2 className="text-base font-bold text-gray-900 mb-2">제7조 (책임 제한)</h2>
          <ul className="list-disc pl-6 flex flex-col gap-1.5">
